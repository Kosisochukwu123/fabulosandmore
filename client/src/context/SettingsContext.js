...
const DEFAULT_SETTINGS = {
  business: {
    ...
    description:  'Premium kitchen utensils and hardware for the modern Nigerian home.',
    logo:         '',
  ...
  shipping: { freeShippingThreshold: 50000, standardCost: 2000, estimatedDays: '3–5 business days', expressAvailable: false, expressCost: 5000, expressEstimatedDays: '1–2 business days' },
  announcement: { enabled: true, text: 'Free delivery on orders over ₦50,000 · WhatsApp: +234 800 000 0000', link: '', bgColor: '#D4AF37', textColor: '#1A1A1A' },
